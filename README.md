<a href="https://softserve.academy/"><div align="center"><img src="https://github.com/project-studying-dotnet/Streetcode-Server-February/blob/main/StreetCodeLogo.jpg" title="SoftServe IT Academy" alt="SoftServe IT Academy"></div></a>
...
[![Github Issues](https://img.shields.io/github/issues/project-studying-dotnet/Streetcode-Server-February?style=flat-square)](https://github.com/project-studying-dotnet/Streetcode-Server-February/issues)
[![Pending Pull-Requests](https://img.shields.io/github/issues-pr/project-studying-dotnet/Streetcode-Server-February?style=flat-square)](https://github.com/project-studying-dotnet/Streetcode-Server-February/pulls)

[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=project-studying-dotnet_Streetcode-Server-February&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=project-studying-dotnet_Streetcode-Server-February)
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=project-studying-dotnet_Streetcode-Server-February&metric=coverage)](https://sonarcloud.io/summary/new_code?id=project-studying-dotnet_Streetcode-Server-February)
[![Bugs](https://sonarcloud.io/api/project_badges/measure?project=project-studying-dotnet_Streetcode-Server-February&metric=bugs)](https://sonarcloud.io/summary/new_code?id=project-studying-dotnet_Streetcode-Server-February)
[![Code Smells](https://sonarcloud.io/api/project_badges/measure?project=project-studying-dotnet_Streetcode-Server-February&metric=code_smells)](https://sonarcloud.io/summary/new_code?id=project-studying-dotnet_Streetcode-Server-February)
[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=project-studying-dotnet_Streetcode-Server-February&metric=security_rating)](https://sonarcloud.io/summary/new_code?id=project-studying-dotnet_Streetcode-Server-February)
[![Vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=project-studying-dotnet_Streetcode-Server-February&metric=vulnerabilities)](https://sonarcloud.io/summary/new_code?id=project-studying-dotnet_Streetcode-Server-February)
---
...
### Clone
  ...
  ```
https://github.com/project-studying-dotnet/Streetcode-Server-February
  ```
  Or if your have an associated SSH key:
  ```
git@github.com:project-studying-dotnet/Streetcode-Server-February.git
  ```
...
- 🔃 Create a new pull request using <a href="https://github.com/project-studying-dotnet/Streetcode-Server-February.git" target="_blank">*this link*</a>.

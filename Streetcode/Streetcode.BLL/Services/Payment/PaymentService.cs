...
{
    private readonly PaymentEnvironmentVariables _paymentEnvironment;
    private readonly HttpClient _httpClient;
    public PaymentService(IOptions<PaymentEnvironmentVariables> paymentEnvironment)
    {
        _paymentEnvironment = paymentEnvironment.Value;
        _httpClient = new HttpClient();
        _httpClient.BaseAddress = new Uri(Api.Production);
        _httpClient.DefaultRequestHeaders.Clear();
        _httpClient.DefaultRequestHeaders.Add(RequestHeaders.XToken, _paymentEnvironment.Token);
    }

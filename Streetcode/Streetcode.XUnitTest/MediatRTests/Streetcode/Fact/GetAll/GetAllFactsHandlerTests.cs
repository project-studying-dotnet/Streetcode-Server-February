...
namespace Streetcode.XUnitTest.MediatRTests.Streetcode.Fact.GetAll;
...
public class GetAllFactsHandlerTests
{
    ...
    public GetAllFactsHandlerTests()
    {
        ...
        _handler = new GetAllFactsHandler(
            _mockRepo.Object,
            _mockMapper.Object,
            _mockLogger.Object);
    }
    ...
    public async Task Handle_WhenFactsExist_ReturnsSuccessResult()
    {
        ...
        {
            new FactEntity { Id = 1, Title = "Fact 1" },
            new FactEntity { Id = 2, Title = "Fact 2" }
        };
    ...
    [Fact]
    public async Task Handle_WhenNoFactsExist_ReturnsEmptyList()
    {
        // Arrange
        var facts = new List<FactEntity>();
        var factsDto = new List<FactDTO>();
    ...
    public async Task Handle_WhenRepositoryReturnsNull_ReturnsFailure()
    {
        ...
        var expectedMsg = "Cannot find any fact";
        result.Errors.Should().Contain(e => e.Message == expectedMsg);
        _mockLogger.Verify(
            l => l.LogError(
                It.IsAny<GetAllFactsQuery>(),
                expectedMsg),
            Times.Once);
    }
